                ...
                <div class="col-span-4 lg:col-span-2 grid grid-cols-2 gap-3">
                    <div class="col-span-2">
                        ...
                        <input
                            ...
                            name="name"
                            id="name"
                            class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm @error('name') border-red-500 @else border-gray-300 @enderror" x-model="categoryName">
                        @error('name')
