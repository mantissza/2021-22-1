            ...
            <div class="grid grid-cols-4 gap-6">
                <div class="col-span-4 lg:col-span-2 grid grid-cols-2 gap-3">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm shadow-md @error('name') border-red-400 @else border-gray-400 @enderror" x-model="categoryName">
                        @error('name')
